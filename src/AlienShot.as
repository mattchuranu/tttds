package  
{
	...
	{
		[Embed(source = '/img/AlienShot2.png')] private const ALIENSHOT:Class;
		private var alX:int;
		private var alY:int;
		...
		public function AlienShot(_x:Number, _y:Number, _dx:Number, _dy:Number):void
		{
			graphic = new Image(ALIENSHOT);
			x = _x;
			y = _y;
			layer = 4;
			type = "alshot";
